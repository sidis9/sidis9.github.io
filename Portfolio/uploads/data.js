...
const DATA = {
  ...
  about: "Five-plus years working at the intersection of marketing and data. I built and ran my own direct-to-consumer fine jewelry brand from zero (2018–2023), and held a full-time marketing analytics role on a small B2B team in parallel — building dashboards in Power BI and Looker Studio, reconciling cross-platform data, and reporting weekly to leadership. STEM-designated M.S. in Business Analytics from Webster University (2025). I'm most interested in companies where the data team and the go-to-market team are in the same room.",
  ...
  experience: [
    {
      role: "Marketing Analyst & Founder",
      company: "Mala Pasal",
